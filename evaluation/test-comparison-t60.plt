...
#set encoding utf8
set output "../doc/figures/test-comparison-t60.tex"
set style data histogram
set style histogram clustered gap 1
set boxwidth 0.8
set style fill solid border -1
set ylabel '\footnotesize{Laufzeit in Sekunden}'
set xlabel '\footnotesize{Nummer der Probleminstanz (\texttt{t60\_})}'
#set yrange[0:215]
set xrange[0:10]

#key settings
set key at 8,8.7 top right
set key width -4.3 samplen 3 spacing 1.15
...
plot 'data/test_comparison_t60_combined.dat' using 2:xticlabels(1) ls 1 title '\footnotesize{HGGA}', \
