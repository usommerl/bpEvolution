...
Im Verlauf der Untersuchungen von E. Falkenauer mit dem HGGA konnte diese theoretisch optimale Lösung für alle Instanzen außer \texttt{u120\_08}, \texttt{u120\_19}, \texttt{u250\_07}, \texttt{u250\_12}, \texttt{u250\_13}, \texttt{t60\_07} und \texttt{t60\_18} auch praktisch ermittelt werden. Für die eben genannten Instanzen wurde dagegen eine Lösung gefunden, die jeweils einen Behälter mehr benötigt als die theoretische minimale Lösung. \parencite[19-22]{Falkenauer:1996} 
    ...
    Um die Mutationsalgorithmen zu vergleichen, wurde ebenfalls 11 mal ein festgelegte Probleminstanz (\texttt{u120\_02}) mit jedem Mutationsalgorithmus bearbeitet. Im Anschluss wurde bei allen Testläufen ermittelt, in welcher Generation die erste Lösung gefunden wurde, die dem theoretischem Optimum entspricht. Von diesen Werten wurde für jeden Algorithmus der Median gebildet und zum Vergleich der Mutationsverfahren verwendet. Konnte in einem Tests keine optimale Lösung gefunden werden, wurde der Wert des Testlaufs auf $\infty$ gesetzt. Der Vergleich auf Basis der Generation wurde gewählt, da dabei die unterschiedlichen Laufzeiten der Mutationsalgorithmen keinen Einfluss haben.    
    ...
    \autoref{plt:mutations01} zeigt das Ergebnis dieses Vergleichs. Das Verhältnis über den Balken des Histograms gibt an, wie oft die Suche in der entsprechenden Konfiguration mit einer optimalen Lösung beendet werden konnte.  
